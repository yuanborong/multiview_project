set -x
echo "----------------------------------------------------------------------------------------------"
#conda create -n xgboost_w4 python=3
env=/opt/anaconda3/envs/xgboost_w4/bin
export PATH=/opt/anaconda3/envs/xgboost_w4/bin:$PATH
...
$env/python3 /home/lpatel/projects/repos/xgboost/z_xgboost_aki_tesing_w4.py
