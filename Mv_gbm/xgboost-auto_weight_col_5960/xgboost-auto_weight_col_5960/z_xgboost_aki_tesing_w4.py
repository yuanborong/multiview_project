...
# params = {'booster': 'gbtree', 'max_depth': 10, 'min_child_weight': 8, 'eta': 0.3, 'objective': 'binary:logistic', 'n_jobs': 20, 'silent': True, 'eval_metric': 'logloss', 'subsample': 0.8, 'colsample_bytree': 0.8135008327693973, 'seed': 1001}
model = xgb.XGBClassifier(
booster= 'gbtree', max_depth= 10, min_child_weight= 8, eta= 0.3, objective= 'binary:logistic', n_jobs= 20, silent= True, eval_metric= 'logloss', subsample= 0.8, colsample_bytree= 0.8135008327693973, seed= 1001
)
...
df.to_csv("/home/lpatel/aki/results/feature_importance_tesing.csv"+t+'_w4',index=False)
