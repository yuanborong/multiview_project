...
# params = {'booster': 'gbtree', 'max_depth': 10, 'min_child_weight': 9, 'eta': 0.3, 'objective': 'binary:logistic', 'n_jobs': 20, 'silent': True, 'eval_metric': 'logloss', 'subsample': 0.5, 'colsample_bytree': 0.5000000162329814, 'seed': 1001}
model = xgb.XGBClassifier(
  booster= 'gbtree', max_depth= 10, min_child_weight= 9, eta= 0.3, objective= 'binary:logistic', n_jobs= 20, silent= True, eval_metric= 'logloss', subsample= 0.5, colsample_bytree= 0.5000000162329814, seed= 1001
)
...
df.to_csv("/home/lpatel/aki/results/feature_importance_tesing.csv"+t+'_w3',index=False)
